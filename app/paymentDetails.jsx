      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {status === "completed" && (
          ...
          >
            ...
            <Text
              style={{ marginLeft: 12, fontWeight: "700", color: "#2E7D32" }}
            >
          ...
          booking.paymentSplit?.status === "completed" && (
            ...
            >
              ...
              {(() => {
                ...
                const commissionRate = partner?.commissionPercent || 80; // fallback 80%
                const partnerEarning = Math.round(
                    ...
                    >
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 14, color: "#065F46" }}>
                          ₹{servicePrice}.00 × {commissionRate}% = ₹
                          {partnerEarning}.00
                        </Text>
                      </View>
                      <View
