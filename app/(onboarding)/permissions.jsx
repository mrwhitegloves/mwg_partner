  ...
  const handleContinue = async () => {
    if (permissions.notification) {
      ...
      Toast.show({
        ...
        text2: "Please grant notification permissions.",
      });
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          To receive high-priority booking alerts even when the app is closed,
          please enable the following:
        </Text>

        {/* 1. Notification Permission */}
        <View
          style={[styles.card, permissions.notification && styles.cardActive]}
        >
          <View
            style={[
              styles.cardIcon,
              permissions.notification && styles.iconActive,
            ]}
          >
            <Ionicons
              name="notifications"
              size={24}
              color={permissions.notification ? "#FFF" : "#4A90E2"}
            />
          </View>
          <View style={{ flex: 1 }}>
          ...
          <TouchableOpacity
            style={[
              styles.buttonSmall,
              permissions.notification ? styles.buttonDone : {},
            ]}
        ...
        <TouchableOpacity
          style={[
            styles.mainButton,
            !permissions.notification && styles.mainButtonDisabled,
          ]}
