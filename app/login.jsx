    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFF' }} edges={['top']}>
      ...
      >
        ...
        <ScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 32 }}>
          <Text style={{ fontSize: 36, fontWeight: 'bold', marginVertical: 32 }}>
            Partner Login
          </Text>

          <View style={inputStyle}>
            <Ionicons name="person-outline" size={20} color="#999" style={{ marginRight: 12 }} />
            <TextInput
              placeholder="Email or Phone"
              value={emailOrPhone}
              onChangeText={setEmailOrPhone}
              keyboardType={isValidPhone(emailOrPhone) ? 'phone-pad' : 'email-address'}
              autoCapitalize="none"
          ...
          <View style={inputStyle}>
            <Ionicons name="lock-closed-outline" size={20} color="#999" style={{ marginRight: 12 }} />
            <TextInput
