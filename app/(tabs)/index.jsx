...
const handleNotificationDecline = () => {
  ...
  return (
    ...
    />
      ...
      >
              <View key={booking._id} style={{ backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                    <Image source={{ uri: booking.services[0].imageUrl }} style={{ width: 50, height: 50, borderRadius: 8, backgroundColor: '#F5F5F5', marginRight: 12 }} />
                  ...
                  <View style={{ alignItems: 'flex-end' }}>
                    ...
                    <Text style={{ fontSize: 18, fontWeight: '700', color: '#4CAF50' }}>₹{booking.pricing.total}</Text>
                  </View>
                </View>
                ...
                <View style={{ marginBottom: 16 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ fontSize: 14, color: '#666', marginLeft: 6 }}>{formatTime(booking.scheduledTime)}</Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, paddingHorizontal: 16, borderRadius: 8, backgroundColor: statusStyle.bg }}>
                  <MaterialIcons name={booking.status === 'completed' ? 'check-circle' : 'access-time'} size={20} color={statusStyle.color} />
        ...
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.9)", justifyContent: "center", alignItems: "center", }} >
          <View style={{ backgroundColor: "#fff", borderRadius: 24, padding: 32, width: "90%", alignItems: "center", }} >
            ...
            {currentBooking && (
              <>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", marginVertical: 8, }} >
                  ...
                  <Text style={{ fontSize: 16, textAlign: "right", flex: 1, marginLeft: 20, }} >
                    {new Date(currentBooking.scheduledDate).toLocaleDateString('en-GB')}
                  </Text>
                </View>
            ...
            <View style={{ flexDirection: "row", gap: 16, marginTop: 32, width: "100%", }} >
              <TouchableOpacity style={{ flex: 1, backgroundColor: "#E74C3C", padding: 16, borderRadius: 12, alignItems: "center", }}
              ...
              <TouchableOpacity style={{ flex: 1, backgroundColor: "#2ECC71", padding: 16, borderRadius: 12, alignItems: "center", }}
