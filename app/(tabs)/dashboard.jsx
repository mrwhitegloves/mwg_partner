  ...
  const performanceData = [
    {
      ...
      value: data.performance.totalBookings.toString(),
      icon: "calendar",
      color: "#4CAF50",
      bgColor: "#E8F5E9",
    },
    {
      label: "Completed",
      value: data.performance.completed.toString(),
    ...
    {
      label: "Pending",
      value: data.performance.pending.toString(),
      icon: "time-outline",
      color: "#FF9800",
      bgColor: "#FFF3E0",
    },
    {
      label: "Cancelled",
      value: data.performance.cancelled.toString(),
      icon: "close-circle",
      color: "#F44336",
      bgColor: "#FFEBEE",
    },
  ...
  const revenueData = [
    {
      ...
      color: "#9C27B0",
      bgColor: "#F3E5F5",
      screen: "/revenue-breakdown",
    },
    {
      label: "Pending Revenue",
      value: formatCurrency(data.revenue.pendingRevenue),
      icon: "time-outline",
      color: "#795548",
      bgColor: "#EFEBE9",
    },
  ...
  return (
    ...
    >
      ...
      <ScrollView
        ...
        refreshControl={
          // ← THIS IS THE ONLY NEW LINE YOU SEE
          <RefreshControl
      ...
      >
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <TouchableOpacity
            onPress={() => router.push("/revenue-breakdown")}
            style={{
              backgroundColor: "#FFFFFF",
              borderRadius: 12,
              padding: 16,
        ...
        >
          ...
          <Text style={{ fontSize: 36, fontWeight: "700", color: "#9C27B0" }}>
            {currentMonthEarningsDisplay}
          </Text>
        </View>
            ...
            data.history.map((item, index) => (
              <View
                ...
                style={{
                  ...
                  alignItems: "center",
                  paddingVertical: 12,
                  borderBottomWidth: index < data.history.length - 1 ? 1 : 0,
