...
export default function BookingsScreen() {
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      case "completed":
        return { color: "#4CAF50", bg: "#E8F5E9", icon: "check-circle" };
      case "in-progress":
        return { color: "#1976D2", bg: "#E3F2FD", icon: "access-time" };
      case "confirmed":
      case "enroute":
      case "arrived":
        return { color: "#FF9800", bg: "#FFF3E0", icon: "access-time" };
      case "cancelled":
      case "failed":
        return { color: "#F44336", bg: "#FFEBEE", icon: "cancel" };
      default:
        return { color: "#666", bg: "#F5F5F5", icon: "hourglass-empty" };
    }
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 16, color: "#000", marginLeft: 4 }}>
            Filter
          </Text>
        </TouchableOpacity>
      </View>
            ...
            {filteredBookings.map((booking) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                  onPress={() =>
                    router.push(`/bookingDetails?id=${booking._id}`)
                  }
            ...
            {STATUS_OPTIONS.map((item) => (
              <TouchableOpacity
                ...
                style={{
                  padding: 16,
                  backgroundColor:
                    filterStatus === item.value ? "#1976D2" : "#F5F5F5",
                  borderRadius: 12,
                  marginBottom: 8,
                }}
              >
                <Text
                  style={{
                    textAlign: "center",
                    color: filterStatus === item.value ? "#FFF" : "#000",
                    fontWeight: "600",
                  }}
                >
                  {item.label}
