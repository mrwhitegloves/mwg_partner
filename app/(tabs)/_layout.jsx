      ...
      <NotificationProvider>
        ...
        <View
          style={{
            ...
            elevation: 5,
            paddingBottom: insets.bottom,  // ← Responsive for gesture bar
          }}>
            ...
            <TouchableOpacity
              ...
              <View
                style={{
                  ...
                  justifyContent: 'center',
                  alignItems: 'center',
                  shadowColor: currentTab === 'dashboard' ? '#0f3867' : '#000',
                  shadowOffset: { width: 0, height: spacing.sm },
                  shadowOpacity: 0.15,
                  shadowRadius: spacing.lg,
                  elevation: 6,
                ...
                <Ionicons name="grid-outline" size={icon.md} color={currentTab === 'dashboard' ? '#4A90E2' : '#333'} />
              </View>
              <Text
                style={{
                  fontSize: font.xs,
                  color: currentTab === 'dashboard' ? '#4A90E2' : '#999',
                  marginTop: spacing.xs,
                  fontWeight: '500',
                }}>
                Dashboard
