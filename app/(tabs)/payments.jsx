...
import { spacing } from "@/services/ui";
      ...
      >
        ...
        >
          <MaterialIcons
            name="receipt"
            size={20}
            color={activeTab === "cash" ? "#FFF" : "#666"}
          />
          <Text
            style={[styles.tabText, activeTab === "cash" && { color: "#FFF" }]}
          >
            Cash Audit
          </Text>
        </TouchableOpacity>
                ...
                {[
                  {
                    ...
                    value: `₹${filteredSummary.totalEarnings}`,
                    color: "#9C27B0",
                  },
                  {
                    label: "Online",
                    icon: "book-online",
                    value: `₹${filteredSummary.onlineEarnings}`,
                    color: "#4CAF50",
                  },
                  {
                    label: "Cash",
                    icon: "money",
                    value: `₹${filteredSummary.cashEarnings}`,
                    color: "#F44336",
                  },
                ].map((item, i) => (
            ...
            {filteredBookings.length === 0 ? (
              ...
              filteredBookings.map((booking) => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                  onPress={() =>
                    router.push(`/paymentDetails?id=${booking.id}`)
                  }
                >
                  <View
                    style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Text
                  style={{ fontSize: 17, fontWeight: "600", color: "#5C6BC0" }}
                >
                  Done
                </Text>
              </TouchableOpacity>
            ...
            >
              <Text
                style={[
                  styles.dateText,
                  tempStartDate && styles.dateTextSelected,
                ]}
              >
                {tempStartDate
                  ? tempStartDate.toLocaleDateString("en-IN")
                  : "Start Date"}
              </Text>
            ...
            <TouchableOpacity
              style={[styles.dateButton, { marginTop: 16 }]}
              onPress={() => setShowEndPicker(true)}
            >
              <Text
                style={[
                  styles.dateText,
                  tempEndDate && styles.dateTextSelected,
                ]}
              >
                {tempEndDate
                  ? tempEndDate.toLocaleDateString("en-IN")
                  : "End Date"}
              </Text>
              <Ionicons name="calendar" size={24} color="#5C6BC0" />
            </TouchableOpacity>
